...
.pull-left[
* The application of IceSat-2 is useful in monitoing changes in sea ice extent which is previously hard to quantify due to the remoteness of sea ice.
...
* To explore the underlying factors when comparing to other datasets e.g., topography. 
]
